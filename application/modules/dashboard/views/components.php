...
<div class="main-content-container container-fluid px-4">
	...
	<div class="alert alert-royal-blue alert-dismissible fade show mt-4 mb-0" role="alert">
		<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			<span aria-hidden="true">×</span>
		</button>
		<i class="fa fa-info mx-2"></i>
		<strong>How you doin'?</strong> I'm just a friendly, good-looking notification message and I come in all the colors
		you can see below. Pretty cool, huh?
	</div>
    ...
    <div class="row mb-2">
        ...
        <div class="col mb-4">
            <div class="bg-primary rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
        <div class="col mb-4">
            <div class="bg-secondary rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
        <div class="col mb-4">
            <div class="bg-success rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
        <div class="col mb-4">
            <div class="bg-info rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
        <div class="col mb-4">
            <div class="bg-warning rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
        <div class="col mb-4">
            <div class="bg-danger rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
        <div class="col mb-4">
            <div class="bg-dark rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
        <div class="col mb-4">
            <div class="bg-salmon rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
        <div class="col mb-4">
            <div class="bg-royal-blue rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
        <div class="col mb-4">
            <div class="bg-java rounded text-white text-center p-3"
                 style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"></div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4 mb-3">
                                ...
                                <fieldset>
                                    ...
                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input" id="formsCheckboxChecked"
                                               checked>
                                        <label class="custom-control-label" for="formsCheckboxChecked">Checked</label>
                                    </div>
                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input" id="formsCheckboxDisabled"
                                               disabled>
                                        <label class="custom-control-label" for="formsCheckboxDisabled">Disabled</label>
                                    </div>
                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input"
                                               id="formsCheckboxDisabledChecked" disabled checked>
                                        <label class="custom-control-label" for="formsCheckboxDisabledChecked">Disabled
                                            Checked</label>
                                    </div>
                                </fieldset>
                                <!-- / Checkboxes -->
                            ...
                            <div class="col-sm-12 col-md-4 mb-3">
                                ...
                                <fieldset>
                                    ...
                                    <div class="custom-control custom-radio mb-1">
                                        <input type="radio" id="formsRadioChecked" name="formsRadioChecked"
                                               class="custom-control-input" checked>
                                        <label class="custom-control-label" for="formsRadioChecked">Checked</label>
                                    </div>
                                    <div class="custom-control custom-radio mb-1">
                                        <input type="radio" id="formsRadioDisabled" name="formsRadioDisabled"
                                               class="custom-control-input" disabled>
                                        <label class="custom-control-label" for="formsRadioDisabled">Disabled</label>
                                    </div>
                                    <div class="custom-control custom-radio mb-1">
                                        <input type="radio" id="formsRadioDisabledChecked"
                                               name="formsRadioDisabledChecked" class="custom-control-input" disabled
                                               checked>
                                        <label class="custom-control-label" for="formsRadioDisabledChecked">Disabled
                                            Checked</label>
                                    </div>
                                </fieldset>
                                <!-- / Radios -->
                    ...
                    <li class="list-group-item p-3">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <button type="button" class="mb-2 btn btn-sm btn-royal-blue mr-1">Royal Blue</button>
                                <button type="button" class="mb-2 btn btn-sm btn-java mr-1">Java</button>
                                <button type="button" class="mb-2 btn btn-sm btn-salmon mr-1">Salmon</button>
                            </div>
                        </div>
                        <!-- / Small Buttons -->
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <button type="button" class="mb-2 btn btn-sm btn-outline-secondary mr-1">Secondary
                                </button>
                                ...
                                <button type="button" class="mb-2 btn btn-sm btn-outline-royal-blue mr-1">Royal Blue
                                </button>
                                <button type="button" class="mb-2 btn btn-sm btn-outline-java mr-1">Java</button>
                                <button type="button" class="mb-2 btn btn-sm btn-outline-salmon mr-1">Salmon</button>
                            </div>
                        </div>
                        <!-- / Small Outline Buttons -->
                    </li>
                    <li class="list-group-item p-3">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <button type="button" class="mb-2 btn btn-royal-blue mr-2">Royal Blue</button>
                            </div>
                        </div>
                        <!-- / Normal Buttons -->
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <button type="button" class="mb-2 btn btn-outline-royal-blue mr-2">Royal Blue</button>
                            </div>
                        </div>
                        <!-- / Normal Outline Buttons -->
                    </li>
                                ...
                                <form>
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control" id="inputPassword4"
                                               placeholder="Password" value="myCoolPassword"></div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="inputAddress"
                                               placeholder="1234 Main St"
                                               value="7898 Kensington Junction, New York, USA"></div>
                                    <div class="form-row">
                                ...
                                <form>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control is-invalid" id="validationServer03"
                                               placeholder="Username" value="catalin.vasile" required>
                            ...
                            <div class="col">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="feInputAddress2"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="custom-control custom-checkbox mb-1">
                                                <input type="checkbox" class="custom-control-input"
                                                       id="formsAgreeField">
                                                <label class="custom-control-label" for="formsAgreeField">I agree with
                                                    your
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item px-3">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="progress progress-sm mb-3">
                                <div id="progress-bar-example-2" class="progress-bar bg-royal-blue" role="progressbar"
                                     style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="progress progress-sm mb-3">
                                <div id="progress-bar-example-3" class="progress-bar bg-salmon" role="progressbar"
                                     style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="progress progress-sm">
                                <div id="progress-bar-example-4" class="progress-bar bg-warning" role="progressbar"
                    ...
                    <li class="list-group-item px-3">
                        ...
                        <div class="mb-2">
                            ...
                            <div id="slider-example-2" class="slider-royal-blue my-4">
                                <input type="hidden" class="custom-slider-input">
                                <input type="hidden" class="custom-slider-input"></div>
                        ...
                        <form>
                            ...
                            <div class="btn-group btn-group-toggle mb-3" data-toggle="buttons">
                                <label class="btn btn-white active">
                                    <input type="radio" name="options" id="option1" autocomplete="off" checked> Fizz
                                </label>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="" aria-label="Recipient's username"
                                       aria-describedby="basic-addon2" value="contact">
                              ...
                              <span class="input-group-text">
                                <i class="material-icons">person</i>
                                    ...
                                    <input type="text" class="form-control" id="form1-username" placeholder="Username"
                                           value="design.revision"></div>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group input-group-seamless">
                                    <input type="password" class="form-control" id="form2-password"
                                           placeholder="Password" value="mySuperSecretPa$$word">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item px-3">
                        <form>
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <label class="input-group-text" for="customSelect01">Options</label>
                                </div>
                                <select class="custom-select" id="customSelect01">
                                    <option selected>Choose...</option>
                            ...
                            <!-- Custom Select -->
                            <div class="input-group mb-3">
                                <select class="custom-select" id="customSelect02">
                                    <option selected>Choose...</option>
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
                                    <option value="3">Three</option>
                                ...
                                <div class="input-group-append">
                                    <label class="input-group-text" for="customSelect02">Options</label>
                                </div>
                            </div>
                            <!-- / Custom Select -->
                        </form>
